// PowerRouting for OMNeT++ - Batman Main
// Marcel Ebbrecht, marcel.ebbrecht@googlemail.com
// free software, see LICENSE.md for details
// derived from inetmanet-3.5, BatmanMain.cc
...
typedef inet::inetmanet::ManetRoutingBase ManetRoutingBase;
...
typedef inet::Ieee802Ctrl Ieee802Ctrl;
        ...
        */
        ...
        for (int i = 0; i<getNumWlanInterfaces(); i++)
        {
            ...
            if (isInMacLayer())
            {
                ...
                batman_if->broad = L3Address(inet::MACAddress::BROADCAST_ADDRESS);
            }
            else
            {
                batman_if->address = L3Address(iEntry->ipv4Data()->getIPAddress());
                batman_if->broad = L3Address(inet::IPv4Address::ALLONES_ADDRESS);
            }
