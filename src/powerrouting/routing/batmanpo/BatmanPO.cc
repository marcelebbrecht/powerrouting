// PowerRouting for OMNeT++ - BatmanPO routing
// Marcel Ebbrecht, marcel.ebbrecht@googlemail.com
// free software, see LICENSE.md for details

#include "BatmanPO.h"

Define_Module(BatmanPO);

//void BatmanPO::initialize(int stage)
//{
//    Batman::initialize(stage);
//
...
//}
//
//int BatmanPO::calculateWillingness(int willingness) {
...
//
//// processing hello
//bool BatmanPO::process_hello(Batman_msg& msg, const nsaddr_t &receiver_iface, const nsaddr_t &sender_iface, const int &index) {
//    if ( ! strcmp(host->getSubmodule("energyStorage")->getClassName(), "inet::power::SimpleEpEnergyStorage") ) {
...
//    }
//
//    return Batman::process_hello(msg, receiver_iface, sender_iface, index);
//}
//
//// setter for willingness
//void BatmanPO::setWillingness(int willingnessValue) {
