...
#ifndef __BatmanPO_omnet_h__

#define __BatmanPO_omnet_h__
#include "../batman/BatmanMain.h"
...
//    virtual bool process_hello(Batman_msg&, const nsaddr_t &, const nsaddr_t &, const int &) override;
//
