...
#define mid_timer_  (*midTimer)
    ...
    inet::L3Address getIfaceAddressFromIndex(int index);
  ...
  public:
    ...
    virtual uint32_t getRoute(const inet::L3Address &, std::vector<inet::L3Address> &) override;
    virtual bool getNextHop(const inet::L3Address &, inet::L3Address &add, int &iface, double &) override;
    virtual bool isProactive() override;
    virtual void setRefreshRoute(const inet::L3Address &destination, const inet::L3Address & nextHop,bool isReverse) override {}
    virtual bool isOurType(cPacket *) override;
    virtual bool getDestAddress(cPacket *, inet::L3Address &) override;
    virtual int getRouteGroup(const inet::inetmanet::AddressGroup &gr, std::vector<inet::L3Address>&) override;
    virtual bool getNextHopGroup(const inet::inetmanet::AddressGroup &gr, inet::L3Address &add, int &iface, inet::L3Address&) override;
    virtual int  getRouteGroup(const inet::L3Address&, std::vector<inet::L3Address> &, inet::L3Address&, bool &, int group = 0) override;
    virtual bool getNextHopGroup(const inet::L3Address&, inet::L3Address &add, int &iface, inet::L3Address&, bool &, int group = 0) override;

    //
    virtual void getDistributionPath(const inet::L3Address&, std::vector<inet::L3Address> &path);

    virtual bool isNodeCandidate(const inet::L3Address&);
