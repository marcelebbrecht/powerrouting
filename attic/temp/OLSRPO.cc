...
/////
//bool
//OLSRPO::process_hello(OLSR_msg& msg, const nsaddr_t &receiver_iface, const nsaddr_t &sender_iface, const int &index)
//{
...
/////
//bool
//OLSRPO::process_tc(OLSR_msg& msg, const nsaddr_t &sender_iface, const int &index)
//{
...
//
//int
//OLSRPO::update_topology_tuples(OLSR_msg& msg, int index)
//{
//
//    double now = CURRENT_TIME;
//    OLSR_tc& tc = msg.tc();
...
//                    (*it)->time() = now + OLSRPO::emf_to_seconds(msg.vtime());
//                    (*it)->seq() = tc.ansn();
//                    foundTuple = 1;
//                    tccounter.insert(i);
//                }
...
/////
//bool
//OLSRPO::link_sensing(OLSR_msg& msg, const nsaddr_t &receiver_iface, const nsaddr_t &sender_iface, const int &index)
//{
...
/////
//bool
//OLSRPO::populate_nbset(OLSR_msg& msg)
//{
//    OLSR_hello& hello = msg.hello();
//
...
/////
//bool
//OLSRPO::populate_nb2hopset(OLSR_msg& msg)
//{
//    double now = CURRENT_TIME;
//    OLSR_hello& hello = msg.hello();
...
/////
//void
//OLSRPO::nb_loss(OLSR_link_tuple* tuple)
//{
